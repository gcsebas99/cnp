import { Component, Entity, Frame, Animation, GraphicsComponent } from "excalibur"
...
export class AnimationComponent<Keys extends string> extends Component {
  ...
  private _speed = 1
  private _frameDurations = new WeakMap<Frame, number>()
   ...
   */
  get current() {
    return this.owner.graphics.current as Animation
  }
